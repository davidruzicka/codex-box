...
usage() {
  cat <<'EOF'
Usage:
  ./codex-box.sh [--build] [--force-build] [--no-auto-update] [--network-host] [--project <path>] [-e VAR[=value]]... [-d local|-d <ip>] [-s] -- [codex-args...]
...
HOST_GATEWAY_TARGET="${CODEX_HOST_GATEWAY_TARGET:-host-gateway}"
